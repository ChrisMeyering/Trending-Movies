...
public class MoviesDbHelper extends SQLiteOpenHelper {
    ...
    private ArrayList<String> generateSQL() {
        ...
        final String SQL_CREATE_TOP_RATED_TABLE =
                "CREATE TABLE " + MoviesContract.TopRatedEntry.TABLE_NAME + " ("
                        ...
                        + MoviesContract.TopRatedEntry.COLUMN_PAGE_NUMBER + " INTEGER NOT NULL);";
        final String SQL_CREATE_MOST_POPULAR_TABLE =
                "CREATE TABLE " + MoviesContract.MostPopularEntry.TABLE_NAME + " ("
                        ...
                        + MoviesContract.MostPopularEntry.COLUMN_PAGE_NUMBER + " INTEGER NOT NULL);";
        final String SQL_CREATE_UPCOMING_TABLE =
                "CREATE TABLE " + MoviesContract.UpcomingEntry.TABLE_NAME + " ("
                        ...
                        + MoviesContract.UpcomingEntry.COLUMN_PAGE_NUMBER + " INTEGER NOT NULL);";
        final String SQL_CREATE_NOW_PLAYING_TABLE =
                "CREATE TABLE " + MoviesContract.NowPlayingEntry.TABLE_NAME + " ("
                        ...
                        + MoviesContract.NowPlayingEntry.COLUMN_PAGE_NUMBER + " INTEGER NOT NULL);";
        final String SQL_CREATE_ALL_MOVIES_TABLE =
                "CREATE TABLE " + MoviesContract.MoviesEntry.TABLE_NAME + " ("
                        ...
                        + MoviesContract.MoviesEntry.COLUMN_RELEASE_DATE + " INTEGER, "
        ...
        final String SQL_CREATE_GENRE_IDS_TABLE =
                "CREATE TABLE " + MoviesContract.GenreIdsEntry.TABLE_NAME + " ("
                        ...
                        + MoviesContract.GenreIdsEntry.COLUMN_GENRE_NAME + " TEXT NOT NULL);";
        ...
        SQLInstructions.add(SQL_CREATE_ALL_MOVIES_TABLE);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + MoviesContract.AllMoviesEntry.TABLE_NAME);
        onCreate(db);
    }
}